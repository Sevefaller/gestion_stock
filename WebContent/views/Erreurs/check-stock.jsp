	...
	<body>
		<header>
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="http://localhost:8080/g_stock_hibernate/">Gestio STOCK</a>
                    </div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				swal({
				  title: "Erreur!",
				  text: "La quantité à sortir ne peut pas être supérieure au stock actuel !!!",
				  type : "error"
				},
				function(){
					location.href = "http://localhost:8080/g_stock_hibernate/sortie";
				});
			});
		</script>
	</body>
